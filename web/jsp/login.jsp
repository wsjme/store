 ...
 <div class="form-group">
   ...
   <div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-3">
			<input type="text" class="form-control"  name="ymyzm"   id="inputPassword3" placeholder="请输入验证码">
		</div>
		<div class="col-sm-3">
			<img  id="imgs" src="${pageContext.request.contextPath}/code"  onclick="changeImg()" />
		</div>
		<div id="yzmts"><span style="color: #ff171a">${sessionScope.yzmts}</span></div>
		<script>
            function changeImg()
            {
                var imgs=document.getElementById("imgs");
                imgs.src="${pageContext.request.contextPath}/code?time="+new Date();
            }
		</script>
  </div>
   <div class="form-group">
